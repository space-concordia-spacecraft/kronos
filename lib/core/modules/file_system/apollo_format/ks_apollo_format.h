...
namespace kronos {
    ...
    public:
        ...
        KsResultType WriteFileHeader(const std::vector<ApolloHeader>& headers);
        ...
        //! \return KS_SUCCESS if the operation was successful
        KsResultType WriteRow(const std::vector<uint32_t>& data);
    ...
    public:
        ...
        //! \return KS_SUCCESS if the operation was successful
        KsResultType ReadRow(std::vector<uint32_t>& data);
