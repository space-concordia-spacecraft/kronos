...
#define UART_MUTUAL_BUFFER_SIZE 16

#define USART_UHF_BUFFER_SIZE 16

#define UART_DSS_BUFFER_SIZE 16

#define UART_PL_BUFFER_SIZE 16

#define UART_ADCS_BUFFER_SIZE 16
...
extern struct usart_os_descriptor UART_MUTUAL;
extern uint8_t                    UART_MUTUAL_buffer[];

extern struct usart_os_descriptor USART_UHF;
extern uint8_t                    USART_UHF_buffer[];

extern struct usart_os_descriptor UART_DSS;
extern uint8_t                    UART_DSS_buffer[];

extern struct usart_os_descriptor UART_PL;
extern uint8_t                    UART_PL_buffer[];

extern struct usart_os_descriptor  UART_ADCS;
extern uint8_t                     UART_ADCS_buffer[];
